...
EXTERN_C __declspec(selectany) const GUID TheEventLog = {0xc0f1a27e, 0xaa60, 0x4d7f, {0x8d, 0xd0, 0x82, 0x72, 0x52, 0x7a, 0x77, 0x64}};

#ifndef TheEventLog_Traits
#define TheEventLog_Traits NULL
#endif // TheEventLog_Traits

//
// Channel
//
#define TheEventLog_CHANNEL_Application 0x9

//
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ProcessStarted = {0xa, 0x0, 0x9, 0x4, 0x0, 0x0, 0x8000000000000000};
#define ProcessStarted_value 0xa
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ProcessStopped = {0xb, 0x0, 0x9, 0x4, 0x0, 0x0, 0x8000000000000000};
#define ProcessStopped_value 0xb
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR NoDetection = {0x14, 0x0, 0x9, 0x4, 0x0, 0x0, 0x8000000000000000};
#define NoDetection_value 0x14
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR DetectsMalware = {0x28, 0x0, 0x9, 0x3, 0x0, 0x0, 0x8000000000000000};
#define DetectsMalware_value 0x28
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ConfigurationError = {0x33, 0x0, 0x9, 0x2, 0x0, 0x0, 0x8000000000000000};
#define ConfigurationError_value 0x33
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ProcessUnhandledException = {0x34, 0x0, 0x9, 0x2, 0x0, 0x0, 0x8000000000000000};
#define ProcessUnhandledException_value 0x34
...
//
#define TheEventLog_EventWriteActivity 0
...
//
#define EventWriteProcessStarted() \
        MCGEN_EVENT_ENABLED(ProcessStarted) \
        ? _mcgen_TEMPLATE_FOR_ProcessStarted(&TheEventLog_Context, &ProcessStarted) : 0
#define EventWriteProcessStarted_AssumeEnabled() \
        _mcgen_TEMPLATE_FOR_ProcessStarted(&TheEventLog_Context, &ProcessStarted)
#define EventWriteProcessStarted_ForContext(pContext) \
...
//
#define EventWriteProcessStopped() \
        MCGEN_EVENT_ENABLED(ProcessStopped) \
        ? _mcgen_TEMPLATE_FOR_ProcessStopped(&TheEventLog_Context, &ProcessStopped) : 0
#define EventWriteProcessStopped_AssumeEnabled() \
        _mcgen_TEMPLATE_FOR_ProcessStopped(&TheEventLog_Context, &ProcessStopped)
#define EventWriteProcessStopped_ForContext(pContext) \
...
//
#define EventWriteNoDetection() \
        MCGEN_EVENT_ENABLED(NoDetection) \
        ? _mcgen_TEMPLATE_FOR_NoDetection(&TheEventLog_Context, &NoDetection) : 0
#define EventWriteNoDetection_AssumeEnabled() \
        _mcgen_TEMPLATE_FOR_NoDetection(&TheEventLog_Context, &NoDetection)
#define EventWriteNoDetection_ForContext(pContext) \
...
//
#define EventWriteDetectsMalware() \
        MCGEN_EVENT_ENABLED(DetectsMalware) \
        ? _mcgen_TEMPLATE_FOR_DetectsMalware(&TheEventLog_Context, &DetectsMalware) : 0
#define EventWriteDetectsMalware_AssumeEnabled() \
        _mcgen_TEMPLATE_FOR_DetectsMalware(&TheEventLog_Context, &DetectsMalware)
#define EventWriteDetectsMalware_ForContext(pContext) \
...
//
#define EventWriteConfigurationError(Exception) \
        MCGEN_EVENT_ENABLED(ConfigurationError) \
        ? _mcgen_TEMPLATE_FOR_ConfigurationError(&TheEventLog_Context, &ConfigurationError, Exception) : 0
#define EventWriteConfigurationError_AssumeEnabled(Exception) \
        _mcgen_TEMPLATE_FOR_ConfigurationError(&TheEventLog_Context, &ConfigurationError, Exception)
#define EventWriteConfigurationError_ForContext(pContext, Exception) \
...
//
#define EventWriteProcessUnhandledException(Exception) \
        MCGEN_EVENT_ENABLED(ProcessUnhandledException) \
        ? _mcgen_TEMPLATE_FOR_ProcessUnhandledException(&TheEventLog_Context, &ProcessUnhandledException, Exception) : 0
#define EventWriteProcessUnhandledException_AssumeEnabled(Exception) \
        _mcgen_TEMPLATE_FOR_ProcessUnhandledException(&TheEventLog_Context, &ProcessUnhandledException, Exception)
#define EventWriteProcessUnhandledException_ForContext(pContext, Exception) \
...
//
// Function for template "ServiceException" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
...
#define MSG_Yama_event_10_message            0x0000000AL
#define MSG_Yama_event_11_message            0x0000000BL
#define MSG_Yama_event_20_message            0x00000014L
#define MSG_Yama_event_40_message            0x00000028L
#define MSG_Yama_event_50_message            0x00000033L
#define MSG_Yama_event_51_message            0x00000034L
#define MSG_level_Error                      0x50000002L
#define MSG_level_Informational              0x50000004L
#define MSG_Yama_ProviderMessage             0x90000001L
